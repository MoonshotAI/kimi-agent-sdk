...
| [prompt-logger](../../examples/python/prompt-logger) | Prompt streaming, logging, and file output | Catalogs all examples and writes a Markdown report while logging every message |
