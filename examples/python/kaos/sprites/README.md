...
Sprites is a cloud sandbox service with persistent environments, so files and setup can be reused across runs.

This example shows how to:
- Connect to an existing Sprite or create one dynamically
