...
export function ApprovalDialog() {
  ...
  const content = (
    <div className="p-2 space-y-2 flex-1 min-h-0 overflow-hidden flex flex-col">
      ...
      <div className="text-xs text-foreground/90 break-all leading-relaxed bg-muted/30 py-2 px-2 rounded shrink-0 max-h-32 overflow-y-auto font-mono">{req.description}</div>
