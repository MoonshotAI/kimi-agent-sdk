...
export class BridgeHandler {
  ...
  private createAskUserTool(webviewId: string): ExternalTool {
    return createExternalTool({
      ...
      description: "Ask the user a question with predefined options. Use when you need user input to proceed.",
      parameters: z.object({
      ...
      handler: async (params) => {
        ...
        return new Promise((resolve) => {
          ...
          this.broadcast(Events.AskUserRequest, { id: requestId, question: params.question, options: params.options }, webviewId);
        });
      },
    });
  }
